...
public class StripePaymentPluginApi extends PluginPaymentPluginApi<StripeResponsesRecord, StripeResponses, StripePaymentMethodsRecord, StripePaymentMethods> {
    ...
    /**
     * This is a a required concrete override of the processNotification method. It is currently not
     * used, as the Stripe webhooks are being processed by the StripeWebhookServlet.
     */
    @Override
    public GatewayNotification processNotification(final String notification,
        ...
        // Provide some indication that the notification is getting sent without processing
        logger.warn("Stripe Notification: Ignored: {}", notification);
